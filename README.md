...
#### Gradient of the Loss with Respect to the Weights $\frac{\partial L}{\partial W}$
...
#### Gradient of the Loss with Respect to the Bias $\frac{\partial L}{\partial B}$
...
#### Gradient of the Loss with Respect to the Input Tensor $\frac{\partial L}{\partial X}$
...
#### 权重相对于损失函数的梯度$\frac{\partial L}{\partial W}$
...
#### 偏置对于损失函数的梯度$\frac{\partial L}{\partial B}$
...
#### 输入张量相对于损失函数的梯度$\frac{\partial L}{\partial X}$
